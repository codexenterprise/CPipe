...
if __name__ == "__main__":
    ...
    xian = ShuffleNet(node_name="xian",
                      model_path="./models/zhuzi_4.18_dct_batch32.om",
                      input_size=(3, 96, 96),
                      class_names=[['NG', 'OK']],
                      warmup=True,
    ...
    kaiguanzuo = ShuffleNet(node_name="kaiguanzuo",
                            model_path="./models/kaiguan_11_29_128x192_gray_batch4.om",
                            input_size=(3, 128, 192),
                            class_names=[['开', "未知", '合']],
                            warmup=True,
                            device="npu:0",
    ...
    rp = RTMPose(
        node_name="rp",
        model_path="./models/hand-end2end_batch2.om",
